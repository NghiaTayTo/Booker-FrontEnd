...
const TransactionHistory = () => {
    ...
    const handleSaveAccountInfo = async (key) => {
        try {
            const response = await axios.post(
                ...
                {
                    headers: {
                        'x-api-key': '8f1302e4-77f0-4aa9-a09f-23721284af74key',
                        'x-api-secret': '47c48c0c-f416-40d5-acf8-249dd0c4fa1bsecret',
    ...
    const handleTruDoanhThuCuaHang = async () => {
        try {
            const updatedDoanhThu = store.doanh_thu - money;
            const storeDataUpdate = await updateCuaHang({ ...store, doanh_thu: updatedDoanhThu });
